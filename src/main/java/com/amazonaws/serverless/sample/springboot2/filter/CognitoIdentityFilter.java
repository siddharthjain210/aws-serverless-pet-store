...
public class CognitoIdentityFilter implements Filter {
  public static final String COGNITO_IDENTITY_ATTRIBUTE =
    "com.amazonaws.serverless.cognitoId";
  ...
  public void doFilter(
    ...
    Object apiGwContext = servletRequest.getAttribute(
    ...
    if (
      !AwsProxyRequestContext.class.isAssignableFrom(apiGwContext.getClass())
    ) {
